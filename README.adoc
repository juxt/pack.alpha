...
[source,clojure]
----
$ clj -Sdeps '{:deps {pack/pack.alpha {:git/url "https://github.com/juxt/pack.alpha.git" :sha "…"}}}' -m mach.pack.alpha.capsule deps.edn uberjar.jar build_dir my.cool.application 0.1.0-6-g46100ae
