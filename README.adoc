...
[source,clojure]
----
$ clojure -Sdeps '{:deps {pack/pack.alpha {:git/url "https://github.com/juxt/pack.alpha.git" :sha "dccf2134bcf03726a9465d2b9997c42e5cd91bff"}}}' -m mach.pack.alpha.inject '511c32d4238afb860ad0b16c4827322d80c7d615'
----

TIP: Latest stable sha is `511c32d4238afb860ad0b16c4827322d80c7d615`.
