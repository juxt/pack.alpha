...
[source,clojure]
----
clj -Sdeps '{:deps {pack/pack.alpha {:git/url "https://github.com/juxt/pack.alpha.git" :sha "253173cfb38e16cb7a49c5686f98bb4711fd5a13"}}}' -m mach.pack.alpha.inject 7f46098598f70da960264d6e33e3aed7a107e1bc
----
