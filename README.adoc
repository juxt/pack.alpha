...
WARNING: jcl is based on link:http://www.jdotsoft.com/JarClassLoader.php[Jar Class Loader] which is licensed under GPLv3. In the future an alternative loader will be provided.
