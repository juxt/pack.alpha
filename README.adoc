...
[source,clojure]
----
clojure -Sdeps '{:deps {pack/pack.alpha {:git/url "https://github.com/juxt/pack.alpha.git" :sha "dccf2134bcf03726a9465d2b9997c42e5cd91bff"}}}' -m mach.pack.alpha.inject 'ddbbdbd4001c75647deddaad0f8bb7dc954fcb6f'
----
